...
**Quick Links:** [Installation](#quick-start) | [Architecture](01_PULSE_QUEUE_DESIGN.md) | [MCP Setup](MCP_SETUP.md) | [Contributing](https://github.com/reubenjohn/reeve-bot/blob/master/CONTRIBUTING.md)
...
**The Strategic Question:** Should Reeve be abandoned, merged, compete, or coexist? See **[OpenClaw Comparison](OpenClaw_COMPARISON.md)** for detailed analysis and open invitation for feedback.
...
Contributions are welcome! Please see [Contributing](https://github.com/reubenjohn/reeve-bot/blob/master/CONTRIBUTING.md) for detailed guidelines on:
